    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="Food-fair-toggle">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="#menu-list">Daftar Menu</a></li>
                <li><a href="#reserve">Pemesanan</a></li>
                ...
                <div class="col-xs-12 col-sm-6 dis-table-cell">
                    <div class="section-content">
                        ...
                        <p class="section-content-para">
                            Kalo makan Nasi Goreng terkesan ga gaul dan keren,kalo di Warunk Emus beda ceritanya. Di sini kamu bisa makan Nasi goreng dengan gaul, sambil nongki2 Happy.Selain Nasi goreng disini juga masih banyak menu yang lainya.
                        </p>
                        <p class="section-content-para">
                            Paling penting, di Warunk Emuss kamu bisa habiskan waktu berharga bareng sahabat, pacar, partner bisnis, (ngomongin mimpi2 kamu di masa depan) sambil main PUBG, denger lagu2 hits, atau sekedar wifian, So..Kamu ditunggu di Warunk Emuss. :D
                        </p>
                    </div> <!-- /.section-content -->
                </div>
            </div> <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="section-header">
                                <h2 class="pricing-title">Daftar Menu Makanan Dan Minuman</h2>
        ...
        <div class="container-fluid">
            <div class="row dis-table">
                <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
                    <h2 class="section-title">Tabel Pemesanan!</h2>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="opening-time">
                            <h3 class="opening-time-title">Waktu</h3>
                            <p>Senin - Jum'at : 7:30 AM - 11:30 AM</p>
                            <p>Sabtu & Minggu : 8:00 AM - 9:00 AM</p>

                            <div class="launch">
                                <h4>Siang</h4>
                                <p>Senin - Jum'at : 12:00 PM - 5:00 PM</p>
                            </div>

                            <div class="dinner">
                                <h4>Malam</h4>
                                <p>Senin - Sabtu : 6:00 PM - 1:00 AM</p>
                                <p>Minggu        : 5:30 PM - 12:00 AM</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid color-bg">
        <div class="row dis-table">
            ...
            <div class="col-xs-6 col-sm-6 dis-table-cell">
                <div class="section-content">
                    <p>Selamat Datang Di Warunk Emus</p>
                    <p>+6283829097350</p>
                    <p>musthofa1@gmail.com </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                <div class="row">
                    <form class="contact-form" method="post" action="{{ route('contact.send') }}">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <textarea name="message" type="text" class="form-control" id="message" rows="7" required="required" placeholder="  Pesan"></textarea>
                        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, {{ date('Y') }} <a href="#">Warunk Emuss.</a> <strong> Developed &amp; <i class="far fa-heart"></i> by </strong>
                        <a href="https://www.youtube.com/channel/UCwbVAlvrsD2Tpx93bleNbOA" target="_blank">Programmer</a>
                    </p>
                </div>
            </div>
        </div>
